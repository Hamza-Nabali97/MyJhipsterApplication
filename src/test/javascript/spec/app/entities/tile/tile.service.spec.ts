...
describe('Service Tests', () => {
    describe('Tile Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TileService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tile', () => {
                service.create(new Tile(null)).subscribe(received => {
            ...
            it('should update a Tile', () => {
                service.update(new Tile(123)).subscribe(received => {
